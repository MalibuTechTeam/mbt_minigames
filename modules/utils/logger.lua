--[[ MalibuTech logger — canonical, vendored utility.
  ...
  Config (set in the PER-RESOURCE IDENTITY block at the top; read at call time):
    ...
    Tag       = nil      -- short per-resource badge, e.g. "MINI" (nil = no badge)
...
MBT.Log = MBT.Log or {}
MBT.Log.Tag = 'MINI'   -- short badge, printed as [MINI]
...
local function log(levelName, ...)
	...
	-- Optional per-resource badge (e.g. ^4[MINI]^7) so interleaved multi-resource
